-- --------------------------------------------------------
-- Host:                         db-ld26e-kr.vpc-pub-cdb.ntruss.com
...
-- Dumping structure for table mos.common_code
DROP TABLE IF EXISTS `common_code`;
CREATE TABLE IF NOT EXISTS `common_code` (
  `CODE_GROUP` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '코드 종류(관리자가 분류한 코드의 그룹, 관리자 생성 가능)',
  `CODE` char(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '코드 ID(PK)',
  `CODE_NAME` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '코드 값',
  `CREATE_DATE` datetime NOT NULL COMMENT '등록일(NOW())',
  `UPDATE_DATE` datetime DEFAULT NULL COMMENT '최종 수정일(NOW())',
  PRIMARY KEY (`CODE_GROUP`,`CODE`) USING BTREE,
  KEY `fk_COMMON_CODE_COMMON_CODE_GROUP1` (`CODE_GROUP`) USING BTREE,
  CONSTRAINT `FK_common_code_common_code_group` FOREIGN KEY (`CODE_GROUP`) REFERENCES `common_code_group` (`CODE_GROUP`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- Dumping data for table mos.common_code: ~20 rows (approximately)
DELETE FROM `common_code`;
INSERT INTO `common_code` (`CODE_GROUP`, `CODE`, `CODE_NAME`, `CREATE_DATE`, `UPDATE_DATE`) VALUES
	('M01', 'M01-101', '신고', '2024-03-24 13:45:17', '2024-03-24 13:45:18'),
	('M01', 'M01-102', '삭제', '2024-03-24 13:45:29', '2024-03-24 13:45:29'),
	('M01', 'M01-103', '정상', '2024-03-24 20:20:01', '2024-03-24 20:20:02'),
	('S01', 'S01-101', '모집중', '2024-03-24 13:39:11', '2024-03-24 13:39:12'),
	('S01', 'S01-102', '진행중', '2024-03-24 13:39:35', '2024-03-24 13:39:35'),
	('S01', 'S01-103', '모집완료', '2024-03-24 13:39:47', '2024-03-24 13:39:47'),
	('S01', 'S01-104', '스터디종료', '2024-03-24 13:40:01', '2024-03-24 13:40:01'),
	('S02', 'S02-101', '신고', '2024-03-24 13:40:41', '2024-03-24 13:40:42'),
	('S02', 'S02-102', '삭제', '2024-03-24 13:40:32', '2024-03-24 13:40:32'),
	('S03', 'S03-101', '스터디장', '2024-03-24 13:41:07', '2024-03-24 13:41:07'),
	('S03', 'S03-102', '스터디원', '2024-03-24 13:41:17', '2024-03-24 13:41:17'),
	('S04', 'S04-101', '북스터디', '2024-03-24 21:53:00', '2024-03-24 21:53:01'),
	('S04', 'S04-102', '인강스터디', '2024-03-24 21:53:16', '2024-03-24 21:53:16'),
	('S05', 'S05-101', '온라인', '2024-03-24 22:52:23', '2024-03-24 22:52:23'),
	('S05', 'S05-102', '오프라인', '2024-03-24 22:52:42', '2024-03-24 22:52:42'),
	('S05', 'S05-103', '자유방식', '2024-03-24 22:52:57', '2024-03-24 22:52:57'),
	('W01', 'W01-101', '신고', '2024-03-24 13:41:51', '2024-03-24 13:41:52'),
	('W01', 'W01-102', '삭제', '2024-03-24 13:42:09', '2024-03-24 13:42:09'),
	('W02', 'W02-103', '신고', '2024-03-24 13:44:18', '2024-03-24 13:44:18'),
	('W02', 'W02-104', '삭제', '2024-03-24 13:43:32', '2024-03-24 13:43:32');

-- Dumping structure for table mos.common_code_group
DROP TABLE IF EXISTS `common_code_group`;
CREATE TABLE IF NOT EXISTS `common_code_group` (
  `CODE_GROUP` char(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '코드 그룹 코드',
  `CODE_GROUP_NAME` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `MODULE_CODE` char(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '모듈 코드 (MEMBER, STUDY 등)',
  `CREATE_DATE` datetime NOT NULL COMMENT '등록일(NOW())',
  `UPDATE_DATE` datetime DEFAULT NULL COMMENT '최종 수정일(NOW())',
  PRIMARY KEY (`CODE_GROUP`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- Dumping data for table mos.common_code_group: ~8 rows (approximately)
DELETE FROM `common_code_group`;
INSERT INTO `common_code_group` (`CODE_GROUP`, `CODE_GROUP_NAME`, `MODULE_CODE`, `CREATE_DATE`, `UPDATE_DATE`) VALUES
	('M01', '회원', 'MEMBER', '2024-03-24 13:31:32', '2024-03-24 13:31:33'),
	('S01', '스터디 상태', 'STUDY', '2024-03-24 13:32:05', '2024-03-24 13:32:05'),
	('S02', '스터디 댓글 상태', 'STUDY', '2024-03-24 13:33:26', '2024-03-24 13:33:26'),
	('S03', '스터디 현황', 'STUDY', '2024-03-24 13:34:47', '2024-03-24 13:34:47'),
	('S04', '스터디 카테고리', 'STUDY', '2024-03-24 21:52:34', '2024-03-24 21:52:34'),
	('S05', '스터디 진행 방식', 'STUDY', '2024-03-24 22:51:58', '2024-03-24 22:51:59'),
	('W01', '위키', 'WIKI', '2024-03-24 13:31:51', '2024-03-24 13:31:51'),
	('W02', '위키 댓글 상태', 'WIKI', '2024-03-24 13:37:02', '2024-03-24 13:37:02');

-- Dumping structure for table mos.curriculum
DROP TABLE IF EXISTS `curriculum`;
CREATE TABLE IF NOT EXISTS `curriculum` (
  `wiki_no` int NOT NULL AUTO_INCREMENT COMMENT '위키 키',
  `study_no` int NOT NULL COMMENT '위키가 작성된 스터디의 키',
  ...
  `ordr` int DEFAULT NULL COMMENT '위키의 순서(같은 오더에 다른 레이어)',
  `likes` int NOT NULL DEFAULT '0' COMMENT '유저들에게 받은 좋아요 수 (반정규화)',
  `created_date` datetime NOT NULL DEFAULT (now()) COMMENT '위키를 생성한 시간',
  `updated_date` datetime NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP COMMENT '위키를 업데이트한 시간',
  ...
  `parent_wiki_no` int DEFAULT NULL COMMENT '부모 위키의 키',
  PRIMARY KEY (`wiki_no`) USING BTREE,
  KEY `FK_curriculum_study` (`study_no`),
  KEY `FK_curriculum_curriculum` (`parent_wiki_no`),
  CONSTRAINT `FK_curriculum_curriculum` FOREIGN KEY (`parent_wiki_no`) REFERENCES `curriculum` (`wiki_no`),
  CONSTRAINT `FK_curriculum_study` FOREIGN KEY (`study_no`) REFERENCES `study` (`study_no`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='스터디마다 여러개 가질 수 있는 커리큘럼. 계층을 가진 위키들을 레코드로 가진다.';

-- Dumping data for table mos.curriculum: ~6 rows (approximately)
DELETE FROM `curriculum`;
INSERT INTO `curriculum` (`wiki_no`, `study_no`, `title`, `content`, `layer`, `ordr`, `likes`, `created_date`, `updated_date`, `content_created_date`, `content_last_updated_date`, `stat`, `parent_wiki_no`) VALUES
	(1, 1, '변수', '변수에 대해 훌륭히 정리한 마크다운 문서', 1, 1, 0, '2024-03-26 21:34:54', '2024-03-27 19:05:44', NULL, NULL, '1', NULL),
	(2, 1, '조건문과 반복문', '조건문과 반복문에 대해 훌륭히 정리한 마크다운 문서', 1, 2, 0, '2024-03-26 21:36:12', '2024-03-27 19:05:46', NULL, NULL, '1', NULL),
	(3, 1, 'JVM 메모리 영역', 'JVM이 사용하는 세가지 메모리 영역에 대해서 아주 훌륭하게 정리한 마크다운 문서를 통째로 저장함', 1, 3, 0, '2024-03-26 21:36:54', '2024-03-27 19:05:48', NULL, NULL, '1', NULL),
	(4, 2, '오리엔테이션', '스프링 강의의 오리엔테이션에 대해 재미나게 정리한 마크다운 문서', NULL, NULL, 0, '2024-03-26 21:37:24', '2024-03-26 21:37:24', NULL, NULL, '1', NULL),
	(5, 2, 'IoC 컨테이너 개념', '스프링의 IoC 컨테이너에 대해 기깔나게 정리한 마크다운 문서', NULL, NULL, 0, '2024-03-26 21:37:53', '2024-03-26 21:37:53', NULL, NULL, '1', NULL),
	(6, 3, 'README.MD', '항시운영되는 CS 스터디 진행 방법에 대해 안내된 마크다운 문서', NULL, NULL, 0, '2024-03-26 21:38:40', '2024-03-26 21:38:40', NULL, NULL, '1', NULL),
	(7, 1, '커리큘럼 제목', '커리큘럼 제목 (NULL 허용해야 할 듯)', 0, 0, 0, '2024-03-27 19:05:30', '2024-03-27 19:05:30', NULL, NULL, '1', NULL),
	(8, 1, '변수 1. 리터럴', '리터럴', 2, 1, 0, '2024-03-27 19:06:15', '2024-03-27 19:06:15', NULL, NULL, '1', NULL);

-- Dumping structure for function mos.F_GET_CODE_NAME
DROP FUNCTION IF EXISTS `F_GET_CODE_NAME`;
DELIMITER //
CREATE FUNCTION `F_GET_CODE_NAME`(
	`pCodeGroup` CHAR(10),
	`pCode` CHAR(10)
...
SELECT CODE_NAME INTO returnVal
FROM COMMON_CODE
WHERE CODE_GROUP = pCodeGroup
	AND CODE = pCode;
...
CREATE TABLE IF NOT EXISTS `member` (
  ...
  `photo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'UUID',
  ...
  UNIQUE KEY `photo_path` (`photo`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='회원 개개인에 관한 정보를 저장하는 테이블';

-- Dumping data for table mos.member: ~6 rows (approximately)
DELETE FROM `member`;
INSERT INTO `member` (`member_no`, `email`, `username`, `platform`, `photo`, `created_date`, `updated_date`, `stat`, `score`, `biography`, `belong`, `career`, `job_group`, `social_link`) VALUES
	...
	(6, 'user06@test.com', 'user06', 'so', NULL, '2024-03-26 21:42:52', '2024-03-27 19:34:59', '탈퇴', 1, '탈퇴예정', '어디에도 소속되지 않음', NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `member_study_status` (
  `member_study_status_no` int NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`member_study_status_no`) USING BTREE,
  UNIQUE KEY `인덱스 2` (`member_no`,`study_no`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='회원이 어떤 스터디에 참여했는지를 저장하는 테이블. 다대다 관계를 해소함.';

-- Dumping data for table mos.member_study_status: ~8 rows (approximately)
DELETE FROM `member_study_status`;
INSERT INTO `member_study_status` (`member_study_status_no`, `member_no`, `study_no`, `status`) VALUES
	(1, 1, 1, '1'),
	(2, 1, 2, '1'),
	(3, 2, 1, '1'),
	(4, 2, 2, '1'),
...
CREATE TABLE IF NOT EXISTS `member_tag_status` (
  `member_tag_status_no` int NOT NULL AUTO_INCREMENT,
  `member_no` int NOT NULL COMMENT '회원키',
  `tag_no` int NOT NULL COMMENT '태그키',
  PRIMARY KEY (`member_tag_status_no`),
  UNIQUE KEY `인덱스 2` (`member_no`,`tag_no`),
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='회원이 관심 목록으로 저장한 스킬(기술 스택)들을 저장하는 테이블. 다대다 관계를 해소한다.';

-- Dumping data for table mos.member_tag_status: ~7 rows (approximately)
DELETE FROM `member_tag_status`;
INSERT INTO `member_tag_status` (`member_tag_status_no`, `member_no`, `tag_no`) VALUES
	(1, 1, 1),
	(2, 1, 7),
	(3, 2, 3),
	(4, 2, 4),
...
-- Dumping data for table mos.notification: ~1 rows (approximately)
...
-- Dumping data for table mos.quit_message: ~1 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `study` (
  ...
  `recruitment_deadline` date DEFAULT NULL COMMENT '모집마감일',
...
-- Dumping data for table mos.study: ~3 rows (approximately)
DELETE FROM `study`;
INSERT INTO `study` (`study_no`, `member_no`, `title`, `introduction`, `location`, `start_date`, `end_date`, `status`, `intake`, `method`, `recruitment_deadline`, `created_date`, `updated_date`, `sigg_no`) VALUES
	...
	(2, 2, '[인프런] 김영한 스프링 같이 정리하실 분', '(마크다운문서) [인강스터디소개] 세컨드 브레인 같이 만들어요', NULL, '2024-03-26', '2024-03-27', '0', 2, NULL, NULL, '2024-03-26 21:25:12', '2024-03-27 19:38:09', NULL),
...
-- Dumping data for table mos.study_comment: ~1 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `study_like_status` (
  `study_like_status_no` int NOT NULL AUTO_INCREMENT,
  `member_no` int DEFAULT NULL,
  `study_no` int DEFAULT NULL,
  PRIMARY KEY (`study_like_status_no`),
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='회원이 스터디 모집글에 ''좋아요''를 남긴 경우 그 데이터를 저장하는 테이블. 이 테이블을 통해 회원은 이전에 좋아요한 모집글을 모아볼 수 있다.';

-- Dumping data for table mos.study_like_status: ~1 rows (approximately)
DELETE FROM `study_like_status`;
INSERT INTO `study_like_status` (`study_like_status_no`, `member_no`, `study_no`) VALUES
	(1, 1, 3);
...
CREATE TABLE IF NOT EXISTS `study_tag_status` (
  `study_tag_status_no` int NOT NULL AUTO_INCREMENT,
  `study_no` int DEFAULT NULL,
  `tag_no` int DEFAULT NULL,
  PRIMARY KEY (`study_tag_status_no`),
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='스터디에 설정한 태그들을 저장하는 테이블.';

-- Dumping data for table mos.study_tag_status: ~5 rows (approximately)
DELETE FROM `study_tag_status`;
INSERT INTO `study_tag_status` (`study_tag_status_no`, `study_no`, `tag_no`) VALUES
	(1, 1, 1),
	(2, 2, 1),
	(3, 2, 7),
	(4, 3, 3),
...
-- Dumping data for table mos.tag: ~7 rows (approximately)
DELETE FROM `tag`;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='여러 회원이 여러 위키들에 좋아요를 한 현황. 다대다 관계를 해소함. 본인이 좋아요한 위키를 모아보기 위해 이 테이블을 사용함.';

-- Dumping data for table mos.wiki_like_status: ~1 rows (approximately)
DELETE FROM `wiki_like_status`;
INSERT INTO `wiki_like_status` (`wiki_like_status_no`, `member_no`, `wiki_no`) VALUES
	(1, 1, 4),
	(4, 1, 5);
